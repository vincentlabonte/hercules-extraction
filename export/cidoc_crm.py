...
class CIDOCCRMExporter(Exporter):
    ...
    def export(self, entities, entity_namespace, ontology_namespace, export_language):
        ...
        for entity in entities:
            ...
            g.add( (entity_namespace.term(entity_uuid), RDF.type, ontology_namespace.term(CIDOCCRMExporter.__entity_type_to_ontlogy_type[entity.entity_type])) )
            g.add( (entity_namespace.term(entity_uuid), RDFS.label, Literal(entity.name, lang='fr')) )
